        ...
        <div class="flex items-center justify-between h-20">
            ...
            <div class="flex items-center gap-4 mr-20">
                ...
                <a
                    ...
                    target="_blank"
                    class="hidden md:flex items-center gap-2 bg-purple-700 hover:bg-purple-800 text-white px-6 py-3 rounded-lg font-bold transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5"
                >
