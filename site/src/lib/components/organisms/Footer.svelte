...
<footer class="mt-auto border-t border-victoria-100 bg-white pt-16 font-sans text-victoria-600">
	<div class="container mx-auto grid grid-cols-1 gap-10 px-4 md:grid-cols-2 lg:grid-cols-4 lg:gap-8">
		...
		<div class="flex flex-col items-start">
			...
			<div class="inline-flex items-center gap-2 rounded-lg border border-victoria-200 bg-victoria-50 px-3 py-2 text-xs font-bold text-victoria-700 shadow-sm">
				<svg class="h-4 w-4 text-victoria-800" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
		...
		<div>
			...
			<ul class="space-y-4 text-sm text-victoria-500">
				<li class="flex items-center gap-3">
					...
					<a href={`https://wa.me/55${SITE_INFO.whatsapp.replace(/\D/g, '')}`} target="_blank" class="font-medium hover:text-victoria-800 transition-colors">
						{SITE_INFO.whatsappLabel}
					</a>
				</li>

				<li class="flex items-center gap-3">
					<div class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-indigo-50 text-victoria-800">
						<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
					...
					<a href="mailto:{SITE_INFO.email || 'contato@lupar.com.br'}" class="hover:text-victoria-800 transition-colors">
		...
		<div>
			...
			<a
				...
				class="group flex items-center gap-3 text-sm text-victoria-500 transition-colors hover:text-victoria-800"
			>
				<div class="flex h-10 w-10 shrink-0 transform items-center justify-center rounded-lg bg-victoria-100 shadow-sm transition-all group-hover:-translate-y-1 group-hover:bg-brand group-hover:text-white">
	...
	<div class="mt-16 border-t border-victoria-100 bg-victoria-50 py-6">
		<div class="container mx-auto flex flex-col items-center justify-between gap-4 px-4 text-center text-xs text-victoria-500 md:flex-row md:text-left">
