	...
	<div class="relative h-[50vh] w-full min-w-full bg-victoria-800 md:h-[65vh]">
		...
		<div class="absolute bottom-0 left-0 w-full p-6 md:p-12">
			<div class="container mx-auto">
				<div class="max-w-3xl">
					<span class="mb-4 inline-block rounded-full bg-victoria-800 px-4 py-1 text-xs font-bold uppercase tracking-widest text-white">
						{imovel.tipo} para {imovel.finalidade}
					</span>
					<h1 class="text-3xl font-extrabold text-white md:text-5xl lg:text-6xl">
						{imovel.titulo}
					</h1>
					<div class="mt-4 flex flex-wrap items-center gap-4 text-victoria-300">
		...
		<div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
			<div class="space-y-8 lg:col-span-2">
				...
				<div class="rounded-2xl border border-victoria-100 bg-white p-6 shadow-xl lg:hidden">
					...
					<p class="text-3xl font-black text-victoria-800">{formatarMoeda(imovel.preco)}</p>
				</div>
